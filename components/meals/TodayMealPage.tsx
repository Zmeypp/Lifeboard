...
export default function TodayMealPage({ mealPlan, generationStatus }: Props) {
    ...
    const imageVersion = encodeURIComponent(mealPlan.generated_at ?? "unknown");
    ...
    return (
        <div className="grid flex-1 min-h-0 grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#0b1623] p-6 overflow-hidden">
                <h2 className="mb-5 text-3xl font-bold">🍽️ Plat du jour</h2>
                ...
                <h3 className="text-2xl font-bold">{day.meal.title}</h3>

                <p className="mt-3 text-slate-400">{day.meal.description}</p>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#0b1623] p-6 overflow-y-auto">
                <h2 className="mb-6 text-3xl font-bold">📖 Recette</h2>
                ...
                <h3 className="mt-8 mb-3 font-semibold">Préparation</h3>
                ...
                <div className="space-y-4">
                    {day.recipe.map((step) => (
                        <div key={step.step}>
                            ...
                            <div className="text-slate-400">{step.text}</div>
                        </div>
                    ))}
                </div>
            </div>
